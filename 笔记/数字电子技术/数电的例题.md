...
![|286](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250817203124.png)

然后再看当 $C = 1$ 的时候，此时三态门为**高阻值状态**，此时为逻辑 $1$ 。得到： $F = \overline{B \oplus 1} = B \cdot 1 + \overline{B}\cdot \overline{1} = B$

真值表得到是：

![|225](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250817203539.png)

综合起来得到：

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250817203554.png)

然后是计算得到 $F$

方法可以使用**卡诺图**的方法来得到：

![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250817210127.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818183702.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818184215.png)

有关三态门的第三个题

![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818184903.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818185813.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818190807.png)

具体方法就是用卡诺图来判断。

直接展示正确答案的卡诺图：

![|397](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818191210.png)
...
![|625](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250818200622.png)

其使用的方法依然是**卡诺图分析**

下面这个题是电路分析题：

![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820163351.png)
...
![|153](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820170806.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820173421.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820173808.png)
...
![|225](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820175558.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820175741.png)

#### 使用数据选择器

首先要明确数据选择器具备哪些输入、控制端。

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250906151139.png)

然后，根据提供的逻辑函数、最小项等条件画出卡诺图，如果是上面这种或与式，那么就需要对其化简，或者直接取反。

下面是第五题：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250906153318.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250906170249.png)

可以使用卡诺图的方法（逻辑电路的方法）来实现：

![|300](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250906170353.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250906171505.png)

主要核心问题是理清楚逻辑。

此外，要注意观察每个接口处是否存在非，也就是**小圆圈**，一旦存在，意义相反。

![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250906171850.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912135111.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912151102.png)

有反馈线的，就要慢慢分析，前后是有联系的，相对来说比较复杂。

再来一个例题：

![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912153012.png)

再来一个最复杂的：

![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912155419.png)

这个要注意的是第二个 $D$ 触发器的 $CP$ 脉冲是由第一个触发器的 $\overline{Q_{1}}$ 决定的。

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912155912.png)

下面这个题则是利用功能表以及 $JK$ 触发器来实现。

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912160538.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250912160809.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920154533.png)

![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920155357.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920160042.png)

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920160201.png)
...
![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920161307.png)

![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920161857.png)

分析得到状态方程之后，还没完，还要讨论对于不在循环下是否会出现**挂起**的情况。

![|625](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920162214.png)

如果对与此类问题要求有输出，姑且当作 $Z$ 来处理：

![|625](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250920162414.png)
...
![image.png|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/20251114201131.png)

![image.png|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/20251114201149.png)
