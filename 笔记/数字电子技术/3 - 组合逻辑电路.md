...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426154953.png)
...
![|300](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813164150.png)
...
![|275](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813164625.png)

这里就是竞争与冒险，我们把**有错误发生的竞争称为冒险**

![|275](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813164804.png)
...
![|197](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813170801.png)

其最简形式就是图上两个圈。但是这样就会出现竞争冒险问题，想要避免此类问题。就是避免**圈与圈之间相切**

再上图中，就出现了圈与圈相切。解决方法就是用另外一个圈将这两个相切的圈连接起来。如下图所示：

![|211](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813171130.png)

当然，还有下面这种情况：

![|199](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813171217.png)
...
![|292](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250813171646.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426155232.png)

#### 例一

通过例题来实现理解：

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426155254.png)

直接计算不方便，所以采用分段计算的方法来求最后的 $Y$ ，将每个门电路后面的输出分别计算出来，最后再进行组合，就是最后的 $Y$

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426155537.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426155932.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426160223.png)

当然了，虽然上面这个图看上去非常复杂，但是不要担心，计算方法还是一样的，首先就是逐级写出逻辑函数式：

先看左边这部分电路：

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426160750.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426161056.png)
...
![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426161632.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426170827.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426171333.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426171609.png)

当然，在这个题目中，其实说明的不是很具体，应该是有三分之二的人表示同意，则表决通过，反之，不通过。满足少数服从多数。

下面来列出真值表。

![|250](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426171810.png)
...
![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426174832.png)
...
![|400](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426175556.png)

所以，根据上面描述，得到真值表：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426175640.png)
...
![|400](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426180823.png)

当然，在一些电路中，可以将上面这个半加器化简成一个符号来表示：

![|200](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426181435.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426181759.png)

> [!note]
> 这里需要注意，虽然看上去是两个二进制数在进行相加，但是还隐藏了一个低位进位的输入，所以在真值表上其实是有三个输入。

![|350](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907125745.png)

> [!important]
> $A_i,B_i$ 表示 $A$ 、 $B\textbf{两 个 数 中 的 第 }i$ 位， $C_i- 1\textbf{表 }$ 示来自低位 (第 $i-1$ 位) 的进位， $S_{i}$ 表示全加和， $C_i$ 表示送给高位 (第 $i+1$ 位) 的进位。

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426182409.png)
...
![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907135911.png)
...
![|250](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426184251.png)

实现全加器的逻辑电路如下：

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907135258.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907140726.png)

用两个半加器和一个或门就能得到一个全加器。

##### 全加器实现二进制乘法

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426184803.png)
...
![|400](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426185402.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426190546.png)

特点是 1. 电路简单，连接方便 2. 速度低

![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426190650.png)

##### 超前进位加法器 - 74 LS 283

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250426190801.png)

![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907142443.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907143147.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907143502.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250907152253.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250427172603.png)
...
![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250427172858.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250901171000.png)
...
![|400](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250901180244.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250427173456.png)

在上面这个比较器中，有三个级联输入端，意味着如果这个两个四位二进制数，都相等，那么最后的结果则是根据这个级联输入端来判断的。具体看下面这个功能表。

![|600](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250427173830.png)
...
![|625](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250427174456.png)

![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250901215032.png)
...
![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250901220245.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250427174747.png)

下面来看一下**输入信号**与**输出位数**之间的关系

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505164854.png)
...
![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505165311.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505165804.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505170629.png)

下面这个是以 4 个信号为例子，用卡诺图化简的方法实现为什么 $Y_{1} = I_{2} + I_{3}$

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505212019.png)

进而得到的结果是下面这个，后续可以直接使用这种方法从而快速的求解输出对应输入之间的关系。

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505212313.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505170755.png)
...
![|350](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505171236.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505171635.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820185912.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250820190245.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505172606.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505213600.png)

然后将上面的真值表化简一下，得到右侧的真值表。

最后在这个真值表上找规律：

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505214620.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505215113.png)

###### 74 LS 148 优先编码器

这里就不再是传统的门电路了，而是下面这种集成电路：

![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505174136.png)

右边的是示意图。

下面对引脚进行说明：

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505174241.png)

下面是功能表：

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505174723.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250821201223.png)
...
![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505175704.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505205123.png)

****

补充关于 CD 4532 级联的功能示意。

![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250821202612.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505205311.png)

这个芯片比较特殊，尽管是十位转四位，但是对 $\overline{I_{0}}$ 的编码是隐藏的，当输入端全为 1 的时候，代表 $\overline{I_{0}}$ 为 0，对应的输出是 $1111$

下面是功能（真值）表

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505205611.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250505220201.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506160507.png)

设输入 3 位二进制代码为 $A_{2}$ 、 $A_{1}$ 、 $A_{0}$ ，共有 $2^{3} = 8$ 种不同组合。它有 8 个输出端，用 $Y_{0}$ 、 $Y_{1}$ 、 $\cdots$ 、 $Y_{7}$ 来表示，输出高电平 1 有效 

下面列出其功能表（真值表）

![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506161001.png)

然后是写出逻辑函数表达式：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506161250.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506161707.png)

##### 双 2 线-4 线译码器 139

这一部分使用的比较少。

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250821210710.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506161952.png)

下面对引脚进行说明：

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506162053.png)

只有当 $ST_{A} = 1$ 、 $\overline{ST_{B}}=\overline{ST_{C}} = 0$ 的时候**才进行译码**，否则不进行译码，不进行译码输出的结果就是全 0

下面是其功能表（真值表）

![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506162612.png)
...
![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250821215115.png)
...
![|350](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250821215748.png)

具体的例子如下图：

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250821220430.png)

###### 138 译码器的扩展

有的时候，一片 138 译码器不够用，需要两个 138 译码器组成 4-16 译码器

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250506163403.png)

注意看上图中，利用芯片 $ST_{A}$ 的特性，将其设置为最高位，当 $A_{3} = 0$ 的时候，低位片工作，当 $A_{3}=1$ 的时候，高位片工作。

下面详细解释一下工作原理

![|600](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250508165005.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250822205720.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250822214205.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250822220205.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250822220728.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250822222642.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250822223632.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250508173204.png)

这个芯片是没有**控制端**的

有十个译码输出端，低电平 0 有效。还有四个 8421 BCD 码输入端，从高位到低位依次是 $A_{3}$ 、 $A_{2}$ 、 $A_{1}$ 和 $A_{0}$

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250508173420.png)

下面是它的功能表：

需要注意的是：虽然有四位输入，总共有 $2^{4} =16$ 种输入，但是有效的只有十种，这也就导致了有六种伪码。这六种伪码就全是无效电平。也就是 $1$

![|375](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250508173705.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514151310.png)

注意，在设计中，设计为 **0 为亮，1 为不亮**，本质上还是取反

在数字设备中用得比较多的是**七段数码显示器**，又称为是数码管。常用的有**半导体数码显示器**（LED）和液晶显示器（LCD）等，它们由七段可以发光的字段组合而成。

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514191622.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514191918.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514192159.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250823205749.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250823210336.png)

需要注意的是，当出现**无效码**的时候，**显示译码器**是**灭灯**的

###### 48 集成译码器（显示）

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514192423.png)

48 的输出端高电平有效，需要与共阴极数码管配合才行

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514192757.png)

这里需要注意的是最后一个控制端：（ $\overline{BI / RBO}$ ），这个是既可以当作输入，也可以当作输出。

本质上在后面的功能表上有说明，当其他的输入都无效的时候，这个时候的 $\overline{BI/RBO}$ 是当作输入来用的，输入为 $0$

![|675](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514193410.png)

此外，当 $\overline{RBI}$ 和 $A_{3}$ 、 $A_{2}$ 、 $A_{1}$ 、 $A_{0}$ 输入都为 0 的时候，才控制为**消隐**（**灭零**）

下面这种接法是一种常规接法：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514193658.png)

下面是多位的显示译码器连接到一起实现**多位数码管的动态灭零连接电路**

![|625](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514194736.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514202512.png)

下面是逻辑图：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514202644.png)

相对于原来的 48 译码器，其在无效码的时候也是消隐的。

并且在控制端都为高电平的时候，能够将上一次的输入进行**锁存**

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514202957.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250514203501.png)

数据选择器的输入信号个数 $N$ 与地址码个数 $n$ 的关系为 $N=2 n$

常用 2 选 1、4 选 1、8 选 1 和 16 选 1 等数据选择器。

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831142805.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516170534.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516171157.png)
...
然后是画出电路逻辑图
 ...
 ![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516171924.png)

下面的集成电路为：

**74 LS 153**，当然这个数据选择器是一个双路的，也就是上面有**两个 4 选 1 数据选择器**，而他们的地址段是**通用**的

![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516172126.png)

功能表如下：

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516172338.png)

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516172801.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516173124.png)

下面是功能表：

![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516173533.png)

然后是真值表：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516173558.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516180129.png)

#### 数据选择器的扩展 - 两个 8 选 1 连接成 16 选 1

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250516181534.png)
...
![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831151939.png)
...
![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831193029.png)
...
![|400](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831195148.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831200444.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250922214214.png)

以 $CD$ 为数据选择端

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250901165900.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831200826.png)

****

当然，包括 $\overline{AB}$ 、 $\overline{A+B}$ 在内的各种逻辑表达式，都可以使用 4 选 1 数据选择器来实现。

![|325](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831201027.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250831201423.png)
...
![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250901163822.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250518161304.png)
...
![](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250518162213.png)

然后是**第二个**：

![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250518162421.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250518162825.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250518172521.png)
...
![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521150317.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521175524.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521175757.png)
...
![|575](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521181029.png)

上面的图，就是**最后的连线结果**

再来一个例题：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521193027.png)
...
![|475](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521194230.png)

再来一个例三：

![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521194259.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250521203659.png)

#### 数据选择器实现组合逻辑电路

首先来回顾一下，数据选择器的输出是**标准与或式**，其中包含地址变量的**全部最小项**

![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522155830.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522160726.png)

首先是**代数法来求解**：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522165131.png)
...
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522165836.png)
...
![|450](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522170153.png)

接下来是**用卡诺图来求解**

![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522170414.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522171153.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522180937.png)

然后接下来就是画图：

![|425](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522181201.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522182726.png)
...
![|550](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522183157.png)
...
$$
![|500](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522183746.png)
...
![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522184521.png)

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522185132.png)

然后是对比 151 的卡诺图

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522185357.png)

最后就是画出连线图：

![|525](https://picture-typora.obs.cn-north-4.myhuaweicloud.com/images/Pasted%20image%2020250522185431.png)
